...
class CryptoBot:
    def __init__(self):
        ...
        self.user_states: Dict[int, str] = {}  # user_id -> current_command
        self.setup_handlers()
        self.setup_logging()
    ...
    def setup_handlers(self):
        ...
        async def history_handler(message: Message):
            await message.answer("Please enter the cryptocurrency ticker (e.g., BTC):")
            self.user_states[message.from_user.id] = "history"
        ...
        async def handle_message(message: Message):
            ...
            if state == "rate":
                ...
                self.user_states[user_id] = "subscribe_threshold"
    ...
    async def _handle_rate_ticker(self, message: Message, ticker: str):
        try:
            ...
            self.logger.error(f"Error in _handle_rate_ticker: {str(e)}")
